...
namespace Fluxera.Utilities.Extensions
{
	...
	public static partial class StreamExtensions
	{
		...
		public static void CopyTo(this Stream stream, Stream targetStream, int bufferSize)
		{
			...
			Guard.Against.Null(targetStream);

			Guard.Against.False(stream.CanRead, message: "The stream does not support reading.");
			Guard.Against.False(targetStream.CanWrite, message: "The stream does not support writing.");
